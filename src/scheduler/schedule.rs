...
pub async fn scheduler_start_all_tasks(state: AppState, mut shutdown: broadcast::Receiver<()>) {
...
pub async fn run_minute_loop(state: AppState, shutdown: &mut broadcast::Receiver<()>) {
